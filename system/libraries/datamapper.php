 ...
 * @version 	1.6.1 ($Rev: 278 $) (Based on DataMapper 1.6.0)
 */
...
class DataMapper implements IteratorAggregate {
	...
	function _parse_subquery_object($sql)
	{
		...
		// pattern ends up being (table|`table`).(field|`field`)
		$pattern = '/' . $table_pattern . '\.' . $field_pattern . '/i';
